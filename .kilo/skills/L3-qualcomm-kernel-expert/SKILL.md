...
description: Qualcomm-specific kernel expert (extends kernel-gki-expert) for vendor/qcom/opensource modules, MSM vs GKI, SoC codenames (kalama/pineapple/taro/sun), KMI symbol compliance for QC modules, ADSP/CDSP firmware, cam_smmu faults, qcacld WLAN. Triggers on pineapple/SM8650/waffle paths and qcom_ module errors.
layer: L3
