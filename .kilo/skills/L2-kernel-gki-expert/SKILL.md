...
description: GKI kernel expert for AOSP kernel work - KMI symbol allowlists (abi_gki_aarch64.xml), vendor module authoring/signing, defconfig and config fragments, DT/DTBO, kernel panic triage, GKI version upgrades (6.1/6.6/6.12), 16KB page migration. Use for any GKI kernel, module, or Kconfig task.
layer: L2
